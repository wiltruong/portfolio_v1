...
<i style="font-size:12px;">Final HUD Mockup from my Ubisoft NEXT competition piece</i>
...
After a few more experimentations, I softened the corners of the lines to give it more of a rounded angular look and minimized the overall UI by 10% so that it doesn't take up too much space. I was satisfied at this point, but I felt that the empty space in the bottom corners can be used in a better way, back to the drawing board!
