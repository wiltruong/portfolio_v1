...
<td rowspan="2">This was a term project with different deliverables leading to the final product. The focus of the project was to create a solution (digital or phyisical) based on a problem statement. The problem which was given to us was to create a better experience for Sheridan students who commute to school.</td>
</tr>
<tr>
    <td markdown="span"><b>Role:</b> Research, analysis, <p>UX, UI and prototyping</p></td>
</tr>
</tbody>
</table>
